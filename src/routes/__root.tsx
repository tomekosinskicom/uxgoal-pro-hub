...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A curated directory of the best tools for UX professionals." },
      { name: "author", content: "UXGoal" },
      { property: "og:title", content: "UXGoal — Tools to Reach Your UX Goals" },
      { property: "og:description", content: "A curated directory of the best tools for UX professionals." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "UXGoal — Tools to Reach Your UX Goals" },
      { name: "twitter:description", content: "A curated directory of the best tools for UX professionals." },
